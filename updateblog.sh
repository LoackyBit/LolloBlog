...
SMART_SYNC_SCRIPT="/Users/lorenzo/Documents/GitHub/LolloBlog/smart_sync.py"
HUGO_DIR="/Users/lorenzo/Documents/GitHub/LolloBlog"
REPO_URL="https://github.com/LoackyBit/LolloBlog"

# Step 1: Sincronizzazione intelligente dei post (esclude automaticamente i draft)
echo "Step 1: Sincronizzazione intelligente dei post da Obsidian a Hugo..."
python3 "$SMART_SYNC_SCRIPT"
if [ $? -ne 0 ]; then
    echo "Errore: Sincronizzazione intelligente fallita. Controlla il file smart_sync.py."
    exit 1
fi
echo "Step 1 completato: Sincronizzazione intelligente terminata."
